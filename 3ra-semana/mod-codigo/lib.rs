...
use soroban_sdk::{
    ...
    contractevent // [COM: Añadir 'contractevent' para el macro]
};
...
// [COM: Definición de structs de eventos usando #[contractevent]]
#[contractevent]
pub struct InitEvent {
    // [COM: El nombre de la struct 'InitEvent' es Topic[0]]
    #[topic]
    pub admin: Address, // [COM: Topic[1]]
    pub name: String,   // [COM: Dato]
    pub symbol: String, // [COM: Dato]
    pub decimals: u32,  // [COM: Dato]
}

#[contractevent]
pub struct MintEvent {
    // [COM: El nombre de la struct 'MintEvent' es Topic[0]]
    #[topic]
    pub to: Address,        // [COM: Topic[1]]
    pub amount: i128,       // [COM: Dato]
    pub new_balance: i128,  // [COM: Dato]
    pub new_total: i128,    // [COM: Dato]
}

#[contractevent]
pub struct BurnEvent {
    // [COM: El nombre de la struct 'BurnEvent' es Topic[0]]
    #[topic]
    pub from: Address,      // [COM: Topic[1]]
    pub amount: i128,       // [COM: Dato]
    pub new_balance: i128,  // [COM: Dato]
    pub new_total: i128,    // [COM: Dato]
}
...
pub struct TransferEvent {
    // [COM: El nombre de la struct 'TransferEvent' es Topic[0]]
    #[topic]
    pub from: Address,          // [COM: Topic[1]]
    #[topic]
    pub to: Address,            // [COM: Topic[2]]
    pub amount: i128,           // [COM: Dato]
    pub new_from_balance: i128, // [COM: Dato]
    pub new_to_balance: i128,   // [COM: Dato]
}

#[contractevent]
pub struct ApproveEvent {
    // [COM: El nombre de la struct 'ApproveEvent' es Topic[0]]
    #[topic]
    pub from: Address,          // [COM: Topic[1]]
    #[topic]
    pub spender: Address,       // [COM: Topic[2]]
    pub old_allowance: i128,    // [COM: Dato]
    pub new_allowance: i128,    // [COM: Dato]
}
// [COM: Fin de la definición de structs de eventos]
...
impl TokenTrait for TokenBDB {
    fn initialize(
        ...
        // [COM: Reemplazar env.events().publish con el nuevo macro InitEvent().publish()]
        InitEvent {
            admin: admin.clone(),
            name: name.clone(),
            symbol: symbol.clone(),
    ...
    fn mint(env: Env, to: Address, amount: i128) -> Result<(), TokenError> {
        ...
        // [COM: Reemplazar env.events().publish con el nuevo macro MintEvent().publish()]
        MintEvent {
            to: to.clone(),
            amount,
            new_balance,
    ...
    fn burn(env: Env, from: Address, amount: i128) -> Result<(), TokenError> {
        ...
        // 6. Emitir evento
        // [COM: Reemplazar env.events().publish con el nuevo macro BurnEvent().publish()]
        BurnEvent {
            from: from.clone(),
            amount,
            new_balance,
    ...
    fn transfer(
        ...
        // [COM: Reemplazar env.events().publish con el nuevo macro TransferEvent().publish()]
        TransferEvent {
            from: from.clone(),
            to: to.clone(),
            amount,
    ...
    fn approve(
        ...
        // [COM: Reemplazar env.events().publish con el nuevo macro ApproveEvent().publish()]
        ApproveEvent {
            from: from.clone(),
    ...
    fn transfer_from(
        ...
        // [COM: Reemplazar env.events().publish con el nuevo macro TransferEvent().publish(). Nota: TransferFrom usa el mismo TransferEvent según el estándar CAP-46.]
        TransferEvent {
            from: from.clone(),
            to: to.clone(),
            amount,
        ...
        // [COM: Se podría emitir un evento ApproveEvent adicional para el cambio de allowance, pero CAP-46 solo requiere TransferEvent para transfer_from. Mantenemos el estándar de usar solo TransferEvent en esta función.]
